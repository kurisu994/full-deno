    ...
    <>
      ...
      <div class="bg-[url('/img/steins_gate.png')] bg-cover h-screen h-svh min-w-[320px] flex dark:bg-slate-900 dark:bg-none dark:text-slate-200">
        ...
        <div className="fixed right-0 top-1 px-3">
          ...
          <a className="mx-1 text-xs text-blue-600 cursor-pointer uda" target="_blank" href={`https://ultraportal.feewee.cn/apply/download?k=SErccqRT&_s=${Date.now()}`} >正式环境APP</a>
        </div>
      </div>
    </>
  );
